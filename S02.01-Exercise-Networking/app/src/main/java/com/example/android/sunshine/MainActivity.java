...
public class MainActivity extends AppCompatActivity {
    ...
    private class getWeatherTask extends AsyncTask<String,Void,String[]> {
        ...
        protected String[] doInBackground(String... strings) {
            ...
            String location = strings[0]; // get first element
            //build URL
            URL url = NetworkUtils.buildUrl(location);

            try {
                String jsonWeatherData = NetworkUtils.getResponseFromHttpUrl(url);

                String[] simpleWeather = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(this, jsonWeatherData);
